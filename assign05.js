function getFocus() {
    ...
    document.getElementById("priceCK").innerHTML = "";
    ...
    if(first.match(nameReg)) {
        if(last.match(nameReg)) {
            if(phone.match(phoneReg)) {
                if(document.getElementById("itemA").checked || document.getElementById("itemB").checked || document.getElementById("itemC").checked || document.getElementById("itemD").checked || document.getElementById("itemE").checked || document.getElementById("itemF").checked) {
